...
nasm -felf32 boot.asm -o ofiles/boot.o
...
i686-elf-gcc -T linker.ld -o myos.bin -ffreestanding -O2 -nostdlib ofiles/boot.o ofiles/timer.o ofiles/terminal.o ofiles/string.o ofiles/keyboard.o ofiles/isr.o ofiles/irq.o ofiles/idt.o ofiles/gdt.o ofiles/kernel.o -lgcc
